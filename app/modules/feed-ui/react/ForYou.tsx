...
import type { OfficialOffice } from "~app/modules/data/representatives";
...
import {
  getLastStatus,
  mapToReadableStatus,
} from "~app/modules/data/legislation/format/format.utils";
import { Carousel } from "~app/modules/design-system/Carousel/Carousel";
import type { FYBFilterProps, ForYouProps } from "../feed-ui.types";
import { RepresentativeCard, RepresentativesList } from "./RepresentativesList";
